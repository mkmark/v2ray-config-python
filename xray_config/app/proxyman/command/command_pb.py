...
class AddInboundRequest:
    inbound: Optional[InboundHandlerConfig] = field(
        default_factory=InboundHandlerConfig
    )
...
class AlterInboundRequest:
    tag: Optional[str] = None
    operation: Optional[dict] = field(default_factory=dict)
...
class AddOutboundRequest:
    outbound: Optional[OutboundHandlerConfig] = field(
        default_factory=OutboundHandlerConfig
    )
