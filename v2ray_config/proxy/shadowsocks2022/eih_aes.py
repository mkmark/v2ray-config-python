...
#     ipsk_hash: Optional[list[[aesEIHPskHashSize]byte]] = field(default_factory=list[[aesEIHPskHashSize]byte])
#     psk: Optional[list[int]] = field(default_factory=list[int])
#     psk_hash: Optional[[aesEIHPskHashSize]byte] = field(default_factory=[aesEIHPskHashSize]byte)
#     length: Optional[int] = None
