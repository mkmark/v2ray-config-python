...
class status:
    ...
    tunnelTxToTun: Optional[chan] = field(default_factory=chan)
    tunnelRxFromTun: Optional[chan] = field(default_factory=chan)
    connAdp: Optional[UDPConn2Tun] = field(default_factory=UDPConn2Tun)
